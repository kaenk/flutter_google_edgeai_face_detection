...
struct DefaultConstants {
  ...
  // Face Landmarker 模型路徑（需要下載並添加到項目中）
  // 模型下載地址: https://storage.googleapis.com/mediapipe-models/face_landmarker/face_landmarker/float16/1/face_landmarker.task
  static let faceLandmarkerModelPath: String? = Bundle.main.path(forResource: "face_landmarker", ofType: "task")
